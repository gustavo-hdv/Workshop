...
public class ProdutoDialog extends javax.swing.JFrame {
    ...
    public ProdutoDialog(int userId, MainFrame mainFrame, Produto selectedProduct, boolean updateMode) {
        initComponents();
        configure();
        ...
        if (updateMode) {
            ...
            this.mainTitleTextField.setText("Atualização de Produto");
            
            populateGui(selectedProduct);
        }
    }
    ...
    private void populateGui(Produto selectedProduct) {
        this.descriptionTextField.setText(selectedProduct.getDescricao());
        this.unitTextField.setText(selectedProduct.getValorUnitarioFormated());
        this.amoutTextField.setText(selectedProduct.getQuantidadeFormated());
    }
    ...
    private void initComponents() {
        ...
        mainTitleTextField.setText("Cadastro de Produto");
    ...
    private void performAction() {
        ...
        try {
            ...
            this.descriptionValidationLabel.setText("É preciso inserir uma descrição do produto. *");
            invalidInput = true;
        }
        try {
            BigDecimal unit = new BigDecimal(this.unitTextField.getText().replace(",", "."));
            produto.setValorUnitario(unit);
            this.unitValidationLabel.setText("_");
        } catch (Exception e) {
        ...
        try {
            if (this.updateMode) {           
                new ProdutoDAO().update(produto, userId);
            } else {
                new ProdutoDAO().create(produto);
            }

            if (mainFrame != null && !fromTableManager) {
                this.mainFrame.refreshView("Produtos", null);
                dispose();
            } else {
                TableManager tableManager = new TableManager(this.userId, this.mainFrame, this.orcamentoHolder, new javax.swing.JFrame(), true);
                tableManager.setOrcamentoUpdateMode(this.orcamentoUpdateMode);
